...
public interface RegisterLocalService
	...
	public Register createRegister(long rid);
	...
	public Register deleteRegister(long rid) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Register fetchRegister(long rid);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Register getRegister(long rid) throws PortalException;
